...
--
-- Database: `2018_p0_cpi02_mahfoudiyo`
--
...
INSERT INTO `Admin` (`idAdmin`, `nom`, `prenom`) VALUES
(1, 'Froment', 'Felix');
...
CREATE TABLE IF NOT EXISTS `Amis` (
  `idAmi1` int(11) NOT NULL DEFAULT '0',
  `idAmi2` int(11) NOT NULL DEFAULT '0',
  UNIQUE KEY `coupleAmi` (`idAmi1`,`idAmi2`)
...
CREATE TABLE IF NOT EXISTS `Bloque` (
  `idBloqueur` int(11) NOT NULL,
  `idBloque` int(11) NOT NULL,
  PRIMARY KEY (`idBloqueur`,`idBloque`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `Commentaire` (`idCom`, `content`, `idUtilisateur`, `idPublication`) VALUES
(1, 'Calme toi yons', 2, 1);
...
CREATE TABLE IF NOT EXISTS `demande` (
  ...
  `idDecideur` int(11) NOT NULL,
  UNIQUE KEY `idDemandeur` (`idDemandeur`,`idDecideur`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
--
-- Déchargement des données de la table `demande`
--

INSERT INTO `demande` (`idDemandeur`, `idDecideur`) VALUES
(2, 1);
...
INSERT INTO `Image` (`idImage`, `taille`, `nom`, `type`) VALUES
(1, '500x500', '1fabe2043aa1f13b2058e045b1f7f524', 'jpg'),
(86, '500x500', 'd4d1f74fd291f3ecf3cd0a8572bb940e', 'jpg'),
(87, '500x500', 'femme', 'jpg'),
(88, '500x500', 'homme', 'jpg'),
(90, '225x225', 'ae2d6b232610c9c96792215f26a3b99c', 'jpeg'),
(91, '225x225', '62ad8c931f0e784b8585b0839a873fb7', 'jpeg'),
(92, '675x1023', 'c51016309d10673e92ddc67222a9154d', 'png'),
(93, '675x1023', '44a8d915734212242cac766e9d2598ef', 'png'),
(94, '675x1023', '55b4b91d4fd846a9ce2f908835fcd56e', 'png'),
(95, '675x1023', 'ba6a34c4228edeb92340edd19f39bba0', 'png'),
(96, '675x1023', '01c9c376e48904fbcb1755ca674e9cc9', 'png'),
(97, '675x1023', '7e7a935520f3f3597fadd7396ce631c2', 'png'),
(98, '675x1023', 'dae2202ab0242acb20389df4c384006e', 'png'),
(99, '675x1023', '089210db0bf043ad3415a6684c840f2fpng', 'png'),
(100, '675x1023', '06b1e4b088ed01355f381c8f816dd6ef.png', 'png'),
(101, '675x1023', '1f33c9728d48be3d75074b451945e790.png', 'png'),
(102, '675x1023', 'eb470b651aa6dea14f8e9594cc0977fa.png', 'png'),
(103, '675x1023', 'f2de2ccc8c5126721fe0c121b73032c8.png', 'png'),
(104, '675x1023', '4660d32b3e886d2f03c41f4cf8137db6.png', 'png'),
(105, '675x1023', 'b0386a321d0e7328ccc358e168b04993.png', 'png'),
(106, '675x1023', '6bfdd396c3dc8ee173f9b6d0ea57767f.png', 'png');
...
INSERT INTO `Message` (`idMessage`, `dt`, `content`, `idEmetteur`, `idDestinataire`) VALUES
(2, '2019-05-13 16:52:33', 'Salut toi ;)', 1, 2),
(5, '2019-05-27 18:24:52', 'Nope', 1, 2),
(6, '2019-05-27 09:33:20', 'Salut , ca va ?', 2, 6),
(7, '2019-05-27 08:30:45', 'T''as bientot fini ?', 6, 1),
(8, '2019-06-07 09:49:23', 'Oklm', 1, 6),
(9, '2019-06-07 17:52:11', 'alors ?', 6, 1);

-- --------------------------------------------------------

--
-- Table structure for table `Privee`
--

CREATE TABLE IF NOT EXISTS `Privee` (
  `idPrivee` int(11) NOT NULL AUTO_INCREMENT,
  `mdp` varchar(20) NOT NULL,
  `email` varchar(20) NOT NULL,
  PRIMARY KEY (`idPrivee`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=61 ;

--
-- Dumping data for table `Privee`
--

INSERT INTO `Privee` (`idPrivee`, `mdp`, `email`) VALUES
(1, 'mot2pass', 'adresse@email.com'),
(2, 'mot2pass2', 'adresse2@email.com'),
(6, 'a', 'labatvalen@eisti.eu');
...
CREATE TABLE IF NOT EXISTS `Public` (
  `idPublic` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `Public` (`idPublic`, `nom`, `prenom`, `mail`, `sexe`, `ville`, `job`, `Idpdp`, `ddn`) VALUES
(1, 'Mahfoudi', 'Younes', 'adresse', 'M', 'Pau', 'Etudiant', 88, ''),
(2, 'Ratajkowski', 'Emily', 'adresse2', 'F', NULL, NULL, 87, ''),
(6, 'Labat', 'Valentin', 'labatvalen@eisti.eu', 'Homme', 'Pau', 'Etudiant', 88, '');
...
INSERT INTO `Publication` (`idPublication`, `content`, `legende`, `aime`, `dt`, `idUtilisateur`, `image`) VALUES
(1, 'Salut, j''ai EmRata en ami!', 'heureux', 5, '2019-05-13 12:06:36', 1, 0),
(2, 'HELLO', '?', 0, '2019-05-14 12:51:26', 2, 0),
(3, 'YEEEEEEES', '?', 1, '2019-05-14 15:41:00', 1, 0),
(4, 'fdthtf', 'hrth', 0, '2019-05-14 09:42:35', 2, 0),
(5, 'ersgerg', 'gzergeg', 0, '2019-05-14 06:50:59', 1, 0),
(6, 'serthbr', 'gfyjtryj', 1, '2019-05-14 18:28:38', 1, 0),
(10, 'mon futur bateau inchallah', NULL, 0, '2019-05-20 17:28:23', 1, 1),
(12, 'Publier quelque chose...', NULL, 0, '2019-06-06 16:48:22', 2, 0),
(16, 'je galere Ã  faire mon css', NULL, 0, '2019-06-06 20:45:37', 2, 0),
(17, 'Gauthier t un pd', NULL, 0, '2019-06-06 21:29:57', 2, 0),
(19, 'Bonsoir felix', NULL, 0, '2019-06-07 08:24:15', 2, 0),
(20, 'Ceci est un long texte meme sis je nai rien a dire jaimerai preciser que faire le css est une tache tres chiante mais bon...', NULL, 0, '2019-06-07 09:14:52', 2, 0),
(21, 'Bonsoir enzo', NULL, 0, '2019-06-07 13:14:37', 2, 0);
...
CREATE TABLE IF NOT EXISTS `React` (
  ...
  `idPublication` int(255) NOT NULL,
...
INSERT INTO `React` (`idUtilisateur`, `idPublication`) VALUES
(1, 10),
(2, 2),
(2, 3),
(2, 4),
...
CREATE TABLE IF NOT EXISTS `signalement` (
  ...
  `dt` datetime NOT NULL,
  `idPublication` int(250) DEFAULT '0',
  `idSignaleur` int(11) NOT NULL,
  `idSignale` int(11) NOT NULL,
  `motif` varchar(250) NOT NULL,
  `idMessage` int(11) DEFAULT '0',
...
INSERT INTO `Signalement` (`idSignal`, `dt`, `idPublication`, `idSignaleur`, `idSignale`, `motif`) VALUES
(3, '2019-06-05 15:28:22', 10, 2, 1, 'test signalement'),
(4, '2019-06-05 15:29:17', 10, 2, 1, 'le bateau est pas beau'),
(5, '2019-06-05 15:35:43', 10, 2, 1, 'test signalement'),
(6, '2019-06-06 16:56:51', 10, 2, 1, 'jaime pas');
...
INSERT INTO `utilisateur` (`idUtilisateur`, `idPublic`, `idPrivee`, `Admin`) VALUES
(1, 1, 1, 0),
(2, 2, 2, 0),
(3, 3, 3, 1);
--
...
('def', '2018_p0_cpi02_mahfoudiyo', 'Admin', 'idAdmin', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Admin', 'nom', 2, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Admin', 'prenom', 3, NULL, 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Amis', 'idAmi1', 1, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Amis', 'idAmi2', 2, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Bloque', 'idBloqueur', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Bloque', 'idBloque', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Commentaire', 'idCom', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Commentaire', 'content', 2, NULL, 'YES', 'varchar', 300, 300, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(300)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Commentaire', 'idUtilisateur', 3, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Commentaire', 'idPublication', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Image', 'idImage', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Image', 'taille', 2, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Image', 'nom', 3, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Image', 'type', 4, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Message', 'idMessage', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Message', 'dt', 2, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Message', 'content', 3, NULL, 'YES', 'varchar', 300, 300, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(300)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Message', 'idEmetteur', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Message', 'idDestinataire', 5, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Privee', 'idPrivee', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Privee', 'mdp', 2, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Privee', 'email', 3, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Public', 'idPublic', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Public', 'nom', 2, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Public', 'prenom', 3, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Public', 'mail', 4, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Public', 'sexe', 5, NULL, 'NO', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Public', 'ville', 6, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Public', 'job', 7, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Public', 'Idpdp', 8, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Public', 'ddn', 9, NULL, 'NO', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Publication', 'idPublication', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Publication', 'content', 2, NULL, 'NO', 'varchar', 500, 500, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(500)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Publication', 'legende', 3, NULL, 'YES', 'varchar', 300, 300, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(300)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Publication', 'aime', 4, '0', 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Publication', 'dt', 5, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Publication', 'idUtilisateur', 6, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Publication', 'image', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'React', 'idUtilisateur', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(255)', 'PRI', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'React', 'idPublication', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(255)', 'PRI', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Signalement', 'idSignal', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Signalement', 'dt', 2, NULL, 'NO', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Signalement', 'idPublication', 3, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(250)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Signalement', 'idSignaleur', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Signalement', 'idSignale', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Signalement', 'motif', 6, NULL, 'NO', 'varchar', 250, 250, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(250)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Utilisateur', 'idUtilisateur', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Utilisateur', 'idPublic', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Utilisateur', 'idPrivee', 3, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', '');
...
('ABORTED_CLIENTS', '32'),
('ABORTED_CONNECTS', '922'),
('BINLOG_CACHE_DISK_USE', '0'),
('BINLOG_CACHE_USE', '0'),
('BINLOG_STMT_CACHE_DISK_USE', '0'),
('BINLOG_STMT_CACHE_USE', '0'),
('BYTES_RECEIVED', '956262596'),
('BYTES_SENT', '2611586966'),
('COM_ADMIN_COMMANDS', '4455'),
...
('COM_SAVEPOINT', '0'),
('COM_SELECT', '102343'),
('COM_SET_OPTION', '189464'),
('COM_SIGNAL', '0'),
('COM_SHOW_AUTHORS', '0'),
('COM_SHOW_BINLOG_EVENTS', '0'),
('COM_SHOW_BINLOGS', '1887'),
('COM_SHOW_CHARSETS', '0'),
...
('COM_SHOW_CREATE_TABLE', '20357'),
('COM_SHOW_CREATE_TRIGGER', '0'),
('COM_SHOW_DATABASES', '8138'),
('COM_SHOW_ENGINE_LOGS', '0'),
('COM_SHOW_ENGINE_MUTEX', '0'),
('COM_SHOW_ENGINE_STATUS', '3'),
('COM_SHOW_EVENTS', '0'),
('COM_SHOW_ERRORS', '0'),
('COM_SHOW_FIELDS', '30082'),
('COM_SHOW_FUNCTION_STATUS', '29'),
('COM_SHOW_GRANTS', '1285'),
('COM_SHOW_KEYS', '22039'),
('COM_SHOW_MASTER_STATUS', '2557'),
('COM_SHOW_OPEN_TABLES', '0'),
('COM_SHOW_PLUGINS', '46661'),
('COM_SHOW_PRIVILEGES', '0'),
('COM_SHOW_PROCEDURE_STATUS', '29'),
('COM_SHOW_PROCESSLIST', '18'),
('COM_SHOW_PROFILE', '4'),
('COM_SHOW_PROFILES', '0'),
('COM_SHOW_RELAYLOG_EVENTS', '0'),
('COM_SHOW_SLAVE_HOSTS', '0'),
('COM_SHOW_SLAVE_STATUS', '2557'),
('COM_SHOW_STATUS', '8760'),
('COM_SHOW_STORAGE_ENGINES', '937'),
('COM_SHOW_TABLE_STATUS', '44784'),
('COM_SHOW_TABLES', '17135'),
('COM_SHOW_TRIGGERS', '4937'),
('COM_SHOW_VARIABLES', '11867'),
('COM_SHOW_WARNINGS', '425'),
('COM_SLAVE_START', '0'),
('COM_SLAVE_STOP', '0'),
('COM_STMT_CLOSE', '1'),
('COM_STMT_EXECUTE', '1'),
...
('COMPRESSION', 'OFF'),
('CONNECTIONS', '3291646'),
('CREATED_TMP_DISK_TABLES', '107010'),
('CREATED_TMP_FILES', '171'),
('CREATED_TMP_TABLES', '287106'),
('DELAYED_ERRORS', '0'),
('DELAYED_INSERT_THREADS', '0'),
('DELAYED_WRITES', '0'),
('FLUSH_COMMANDS', '1'),
('HANDLER_COMMIT', '92385'),
('HANDLER_DELETE', '5248'),
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '0'),
('HANDLER_READ_FIRST', '65842'),
('HANDLER_READ_KEY', '160663'),
('HANDLER_READ_LAST', '280'),
('HANDLER_READ_NEXT', '925798'),
('HANDLER_READ_PREV', '2845'),
('HANDLER_READ_RND', '12908'),
('HANDLER_READ_RND_NEXT', '5244685'),
('HANDLER_ROLLBACK', '18084'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '8455'),
('HANDLER_WRITE', '2377335'),
('INNODB_BUFFER_POOL_PAGES_DATA', '1409'),
('INNODB_BUFFER_POOL_BYTES_DATA', '23085056'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_BYTES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '85687'),
('INNODB_BUFFER_POOL_PAGES_FREE', '6781'),
('INNODB_BUFFER_POOL_PAGES_MISC', '2'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '8570859'),
('INNODB_BUFFER_POOL_READS', '1292'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '400133'),
('INNODB_DATA_FSYNCS', '54651'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '25448448'),
('INNODB_DATA_READS', '1512'),
('INNODB_DATA_WRITES', '131094'),
('INNODB_DATA_WRITTEN', '2847078912'),
('INNODB_DBLWR_PAGES_WRITTEN', '85687'),
('INNODB_DBLWR_WRITES', '9458'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '50056'),
('INNODB_LOG_WRITES', '28305'),
('INNODB_OS_LOG_FSYNCS', '35733'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '35483648'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '118'),
('INNODB_PAGES_READ', '1291'),
('INNODB_PAGES_WRITTEN', '85687'),
('INNODB_ROW_LOCK_CURRENT_WAITS', '0'),
('INNODB_ROW_LOCK_TIME', '0'),
('INNODB_ROW_LOCK_TIME_AVG', '0'),
('INNODB_ROW_LOCK_TIME_MAX', '0'),
('INNODB_ROW_LOCK_WAITS', '2'),
('INNODB_ROWS_DELETED', '4485'),
('INNODB_ROWS_INSERTED', '17005'),
('INNODB_ROWS_READ', '3367558'),
('INNODB_ROWS_UPDATED', '8280'),
('INNODB_TRUNCATED_STATUS_WRITES', '0'),
('KEY_BLOCKS_NOT_FLUSHED', '0'),
('KEY_BLOCKS_UNUSED', '13372'),
('KEY_BLOCKS_USED', '74'),
('KEY_READ_REQUESTS', '54829'),
('KEY_READS', '68'),
('KEY_WRITE_REQUESTS', '3884'),
('KEY_WRITES', '3639'),
...
('OPEN_FILES', '28'),
('OPEN_STREAMS', '0'),
('OPEN_TABLE_DEFINITIONS', '395'),
('OPEN_TABLES', '398'),
('OPENED_FILES', '441234'),
('OPENED_TABLE_DEFINITIONS', '6302'),
('OPENED_TABLES', '3277'),
...
('QCACHE_FREE_BLOCKS', '1551'),
('QCACHE_FREE_MEMORY', '7521928'),
('QCACHE_HITS', '3534972'),
('QCACHE_INSERTS', '68606'),
('QCACHE_LOWMEM_PRUNES', '0'),
('QCACHE_NOT_CACHED', '31787'),
('QCACHE_QUERIES_IN_CACHE', '7955'),
('QCACHE_TOTAL_BLOCKS', '17898'),
('QUERIES', '7735947'),
('QUESTIONS', '7722731'),
('RPL_STATUS', 'AUTH_MASTER'),
('SELECT_FULL_JOIN', '762'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '7850224'),
('UPTIME_SINCE_FLUSH_STATUS', '7850224');
...
('OLD_PASSWORDS', 'OFF'),
('GENERAL_LOG_FILE', '/var/lib/mysql/webetu.log'),
...
('SLOW_QUERY_LOG_FILE', '/var/lib/mysql/webetu-slow.log'),
...
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 'def', '2018_p0_cpi02_mahfoudiyo', 'Admin', 'idAdmin', 1, NULL, NULL, NULL, NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'coupleAmi', 'def', '2018_p0_cpi02_mahfoudiyo', 'Amis', 'idAmi1', 1, NULL, NULL, NULL, NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'coupleAmi', 'def', '2018_p0_cpi02_mahfoudiyo', 'Amis', 'idAmi2', 2, NULL, NULL, NULL, NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 'def', '2018_p0_cpi02_mahfoudiyo', 'Bloque', 'idBloqueur', 1, NULL, NULL, NULL, NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 'def', '2018_p0_cpi02_mahfoudiyo', 'Bloque', 'idBloque', 2, NULL, NULL, NULL, NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 'def', '2018_p0_cpi02_mahfoudiyo', 'Commentaire', 'idCom', 1, NULL, NULL, NULL, NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 'def', '2018_p0_cpi02_mahfoudiyo', 'Image', 'idImage', 1, NULL, NULL, NULL, NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 'def', '2018_p0_cpi02_mahfoudiyo', 'Message', 'idMessage', 1, NULL, NULL, NULL, NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 'def', '2018_p0_cpi02_mahfoudiyo', 'Privee', 'idPrivee', 1, NULL, NULL, NULL, NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 'def', '2018_p0_cpi02_mahfoudiyo', 'Public', 'idPublic', 1, NULL, NULL, NULL, NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 'def', '2018_p0_cpi02_mahfoudiyo', 'Publication', 'idPublication', 1, NULL, NULL, NULL, NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 'def', '2018_p0_cpi02_mahfoudiyo', 'React', 'idUtilisateur', 1, NULL, NULL, NULL, NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 'def', '2018_p0_cpi02_mahfoudiyo', 'React', 'idPublication', 2, NULL, NULL, NULL, NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 'def', '2018_p0_cpi02_mahfoudiyo', 'Signalement', 'idSignal', 1, NULL, NULL, NULL, NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 'def', '2018_p0_cpi02_mahfoudiyo', 'Utilisateur', 'idUtilisateur', 1, NULL, NULL, NULL, NULL);
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-06-07 14:03:39', '2019-06-07 14:03:39', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-06-07 14:03:39', '2019-06-07 14:03:39', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-06-07 14:03:39', '2019-06-07 14:03:39', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-06-07 14:03:39', '2019-06-07 14:03:39', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-06-07 14:03:39', '2019-06-07 14:03:39', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-06-07 14:03:39', '2019-06-07 14:03:39', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-06-07 14:03:39', '2019-06-07 14:03:39', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16752736, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-06-07 14:03:39', '2019-06-07 14:03:39', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-06-07 14:03:39', '2019-06-07 14:03:39', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_BUFFER_PAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6852, 0, 16766844, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_BUFFER_POOL_STATS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 257, 0, 16332350, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_BUFFER_PAGE_LRU', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6669, 0, 16765866, 0, 0, '2019-06-07 14:03:39', NULL, NULL, NULL, '', '', NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'Admin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 41943040, '2019-05-13 10:03:20', NULL, NULL, NULL, '', '', NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'Amis', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 3276, 16384, NULL, 0, 41943040, '2019-05-15 12:49:00', NULL, NULL, NULL, '', '', NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'Bloque', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 41943040, '2019-06-07 11:57:25', NULL, NULL, NULL, '', '', NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'Commentaire', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 41943040, '2019-05-13 09:13:27', NULL, NULL, NULL, '', '', NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'Image', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 21, 780, 16384, NULL, 0, 41943040, '2019-05-27 09:29:01', NULL, NULL, NULL, '', '', NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'Message', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 2730, 16384, NULL, 0, 41943040, '2019-05-13 09:30:56', NULL, NULL, NULL, '', '', NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'Privee', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 41943040, '2019-05-13 09:26:15', NULL, NULL, NULL, '', '', NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'Public', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 41943040, '2019-06-06 12:31:35', NULL, NULL, NULL, '', '', NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'Publication', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 13, 1260, 16384, NULL, 0, 41943040, '2019-05-20 15:57:41', NULL, NULL, NULL, '', '', NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'React', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 12, 1365, 16384, NULL, 0, 41943040, '2019-05-31 11:41:05', NULL, NULL, NULL, '', '', NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'Signalement', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 41943040, '2019-06-05 13:18:40', NULL, NULL, NULL, '', '', NULL),
('def', '2018_p0_cpi02_mahfoudiyo', 'Utilisateur', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 41943040, '2019-05-13 09:04:04', NULL, NULL, NULL, '', '', NULL);
...
(3291642, 'mahfoudiyo', 'localhost', '2018_p0_cpi02_mahfoudiyo', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', '2018_p0_cpi02_mahfoudiyo', 'latin1', 'latin1_swedish_ci', NULL);
...
('''mahfoudiyo''@''localhost''', 'def', '2018_p0_cpi02_mahfoudiyo', 'SELECT', 'NO'),
('''mahfoudiyo''@''localhost''', 'def', '2018_p0_cpi02_mahfoudiyo', 'INSERT', 'NO'),
('''mahfoudiyo''@''localhost''', 'def', '2018_p0_cpi02_mahfoudiyo', 'UPDATE', 'NO'),
('''mahfoudiyo''@''localhost''', 'def', '2018_p0_cpi02_mahfoudiyo', 'DELETE', 'NO'),
('''mahfoudiyo''@''localhost''', 'def', '2018_p0_cpi02_mahfoudiyo', 'CREATE', 'NO'),
('''mahfoudiyo''@''localhost''', 'def', '2018_p0_cpi02_mahfoudiyo', 'DROP', 'NO'),
('''mahfoudiyo''@''localhost''', 'def', '2018_p0_cpi02_mahfoudiyo', 'REFERENCES', 'NO'),
('''mahfoudiyo''@''localhost''', 'def', '2018_p0_cpi02_mahfoudiyo', 'INDEX', 'NO'),
('''mahfoudiyo''@''localhost''', 'def', '2018_p0_cpi02_mahfoudiyo', 'ALTER', 'NO'),
('''mahfoudiyo''@''localhost''', 'def', '2018_p0_cpi02_mahfoudiyo', 'CREATE TEMPORARY TABLES', 'NO'),
('''mahfoudiyo''@''localhost''', 'def', '2018_p0_cpi02_mahfoudiyo', 'LOCK TABLES', 'NO'),
('''mahfoudiyo''@''localhost''', 'def', '2018_p0_cpi02_mahfoudiyo', 'EXECUTE', 'NO'),
('''mahfoudiyo''@''localhost''', 'def', '2018_p0_cpi02_mahfoudiyo', 'CREATE VIEW', 'NO'),
('''mahfoudiyo''@''localhost''', 'def', '2018_p0_cpi02_mahfoudiyo', 'SHOW VIEW', 'NO'),
('''mahfoudiyo''@''localhost''', 'def', '2018_p0_cpi02_mahfoudiyo', 'CREATE ROUTINE', 'NO'),
('''mahfoudiyo''@''localhost''', 'def', '2018_p0_cpi02_mahfoudiyo', 'ALTER ROUTINE', 'NO'),
('''mahfoudiyo''@''localhost''', 'def', '2018_p0_cpi02_mahfoudiyo', 'EVENT', 'NO'),
('''mahfoudiyo''@''localhost''', 'def', '2018_p0_cpi02_mahfoudiyo', 'TRIGGER', 'NO');
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '8571111'),
('INNODB_BUFFER_POOL_READS', '1292'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '400133'),
('INNODB_DATA_FSYNCS', '54651'),
...
('def', '2018_p0_cpi02_mahfoudiyo', 'Admin', 0, '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 1, 'idAdmin', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Amis', 0, '2018_p0_cpi02_mahfoudiyo', 'coupleAmi', 1, 'idAmi1', 'A', 5, NULL, NULL, '', 'BTREE', '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Amis', 0, '2018_p0_cpi02_mahfoudiyo', 'coupleAmi', 2, 'idAmi2', 'A', 5, NULL, NULL, '', 'BTREE', '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Bloque', 0, '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 1, 'idBloqueur', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Bloque', 0, '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 2, 'idBloque', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Commentaire', 0, '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 1, 'idCom', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Image', 0, '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 1, 'idImage', 'A', 21, NULL, NULL, '', 'BTREE', '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Message', 0, '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 1, 'idMessage', 'A', 6, NULL, NULL, '', 'BTREE', '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Privee', 0, '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 1, 'idPrivee', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Public', 0, '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 1, 'idPublic', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Publication', 0, '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 1, 'idPublication', 'A', 13, NULL, NULL, '', 'BTREE', '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'React', 0, '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 1, 'idUtilisateur', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'React', 0, '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 2, 'idPublication', 'A', 12, NULL, NULL, '', 'BTREE', '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Signalement', 0, '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 1, 'idSignal', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Utilisateur', 0, '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', 1, 'idUtilisateur', 'A', 3, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-06-07 14:03:39', '2019-06-07 14:03:39', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-06-07 14:03:39', '2019-06-07 14:03:39', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-06-07 14:03:39', '2019-06-07 14:03:39', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-06-07 14:03:39', '2019-06-07 14:03:39', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-06-07 14:03:39', '2019-06-07 14:03:39', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-06-07 14:03:39', '2019-06-07 14:03:39', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-06-07 14:03:39', '2019-06-07 14:03:39', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16752736, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-06-07 14:03:39', '2019-06-07 14:03:39', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-06-07 14:03:39', '2019-06-07 14:03:39', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_BUFFER_PAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6852, 0, 16766844, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2448', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_BUFFER_POOL_STATS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 257, 0, 16332350, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=65280', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_BUFFER_PAGE_LRU', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6669, 0, 16765866, 0, 0, NULL, '2019-06-07 14:03:39', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2515', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Admin', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 41943040, 2, '2019-05-13 10:03:20', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Amis', 'BASE TABLE', 'InnoDB', 10, 'Compact', 5, 3276, 16384, 0, 0, 41943040, NULL, '2019-05-15 12:49:00', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Bloque', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 41943040, NULL, '2019-06-07 11:57:25', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Commentaire', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 41943040, 2, '2019-05-13 09:13:27', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Image', 'BASE TABLE', 'InnoDB', 10, 'Compact', 21, 780, 16384, 0, 0, 41943040, 107, '2019-05-27 09:29:01', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Message', 'BASE TABLE', 'InnoDB', 10, 'Compact', 6, 2730, 16384, 0, 0, 41943040, 10, '2019-05-13 09:30:56', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Privee', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 41943040, 61, '2019-05-13 09:26:15', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Public', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 41943040, 61, '2019-06-06 12:31:35', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Publication', 'BASE TABLE', 'InnoDB', 10, 'Compact', 13, 1260, 16384, 0, 0, 41943040, 22, '2019-05-20 15:57:41', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'React', 'BASE TABLE', 'InnoDB', 10, 'Compact', 12, 1365, 16384, 0, 0, 41943040, NULL, '2019-05-31 11:41:05', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Signalement', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 41943040, 7, '2019-06-05 13:18:40', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', '2018_p0_cpi02_mahfoudiyo', 'Utilisateur', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 41943040, 61, '2019-05-13 09:04:04', NULL, NULL, 'latin1_swedish_ci', NULL, '', '');
...
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', '2018_p0_cpi02_mahfoudiyo', 'Admin', 'PRIMARY KEY'),
('def', '2018_p0_cpi02_mahfoudiyo', 'coupleAmi', '2018_p0_cpi02_mahfoudiyo', 'Amis', 'UNIQUE'),
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', '2018_p0_cpi02_mahfoudiyo', 'Bloque', 'PRIMARY KEY'),
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', '2018_p0_cpi02_mahfoudiyo', 'Commentaire', 'PRIMARY KEY'),
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', '2018_p0_cpi02_mahfoudiyo', 'Image', 'PRIMARY KEY'),
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', '2018_p0_cpi02_mahfoudiyo', 'Message', 'PRIMARY KEY'),
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', '2018_p0_cpi02_mahfoudiyo', 'Privee', 'PRIMARY KEY'),
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', '2018_p0_cpi02_mahfoudiyo', 'Public', 'PRIMARY KEY'),
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', '2018_p0_cpi02_mahfoudiyo', 'Publication', 'PRIMARY KEY'),
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', '2018_p0_cpi02_mahfoudiyo', 'React', 'PRIMARY KEY'),
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', '2018_p0_cpi02_mahfoudiyo', 'Signalement', 'PRIMARY KEY'),
('def', '2018_p0_cpi02_mahfoudiyo', 'PRIMARY', '2018_p0_cpi02_mahfoudiyo', 'Utilisateur', 'PRIMARY KEY');
...
('''mahfoudiyo''@''localhost''', 'def', 'USAGE', 'NO');
