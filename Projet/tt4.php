...
//Page qui traite le blocage. Appelée dans le fichier javascript traitement.js
  ...
  $query4 = "INSERT INTO Bloque (idBloqueur,idBloque) VALUES ('".$id."','".$idautre."')";
  $result4=mysqli_query($db,$query4) or die('Pb req : '.$query4);
